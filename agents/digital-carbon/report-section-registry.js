...
(function (global) {
  ...
  var SECTIONS = [
    { id: 's1', title: '报告定位与核心思路', aliases: ['报告定位', '核心思路', '01', '第一章'] },
    {
      id: 's2',
      title: '和重点工序对标',
      aliases: ['重点工序对标', '重点生产线对标', '烧结炼铁', '烧结+炼铁', '熟料生产线', '02'],
    },
    { id: 's3', title: '企业碳排放强度数据对标', aliases: ['企业碳排放强度', '企业层级', '企业强度对标', '03'] },
    {
      id: 's4',
      title: '工序碳排放强度数据对标',
      aliases: ['工序碳排放强度', '工序层级', '工序强度对标', '生产线碳排放强度', '生产线层级', '04'],
    },
    ...
    { id: 's-facility', title: '生产设施对标', aliases: ['生产设施对标', '设施对标', '设施章节'] },
    {
      id: 's-process-extra',
      title: '工序对标明细',
      aliases: ['工序对标明细', '工序明细', '生产线对标明细', '生产线明细'],
    },
    { id: 's-pollutant', title: '污染物对标', aliases: ['污染物对标', '污染物', '排污对标'] },
    {
      id: 's-quota-cost',
      title: '配额与碳成本',
      aliases: ['配额与碳成本', '配额成本', '碳成本', '碳配额'],
    },
    { id: 's-history', title: '历史核查轨迹', aliases: ['历史核查', '核查轨迹', '历史轨迹', '历史对标轨迹'] },
